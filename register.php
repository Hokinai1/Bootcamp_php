...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    // si le formulaire est soumis, on recupère les données
    $nom = $_POST["nom"];
    $email = $_POST["email"];
    ...
    // stocker directement en utilisant le prepare, on combine la liaison lors de l'execution
    $stmt = $pdo->prepare($sql);

    // execution et liaison
    if($stmt->execute ([
    'nom' => $nom,
    'email'=> $email,
    'password'=> $password,
